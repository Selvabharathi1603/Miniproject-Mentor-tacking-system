    ...
    data.forEach(async (info) => {
        ...
        if(odlist!=null){
            ...
            for (const odRequest of odlist) {
              console.log(odRequest)
              console.log(loginusername)
              console.log(odRequest.mentorname)
              console.log(loginusername.includes((odRequest.mentorname).toLocaleUpperCase()))
                if (odRequest.mentor == "pending" && loginusername.includes((odRequest.mentorname).toLocaleUpperCase())) {
    ...
    data.forEach(async (info) => {
        ...
        if(leavelist!=null){
            ...
            for (const odRequest of leavelist) {
              ...
              // console.log(loginusername.includes(odRequest.mentorname))
